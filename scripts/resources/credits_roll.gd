...
##
## Three lists because the document has three tables and they answer different questions: **who made
## it**, what went into it, and what it was built with. Baked by `tools/build_credits.gd`.
